...
Make platform status, decisions, monitoring, and operations understandable and usable for operators who do not need to know the underlying service vocabulary.
